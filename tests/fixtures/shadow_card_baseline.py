...
SHADOW_CARD_BASELINE: frozenset[ShadowCardKey] = frozenset(
    {
        ...
        ("break_glass.py", "BreakGlassScreen", "__init__", 0),
        ...
        ("group_c.py", "DashboardScreen", "_build_campaign_impact_card", 0),
        ("group_c.py", "DashboardScreen", "_build_cost_center_card", 0),
        ("group_c.py", "DashboardScreen", "_build_duplicates_card", 0),
        ("group_c.py", "DashboardScreen", "_build_operator_performance_card", 0),
        ...
        ("group_c.py", "DashboardScreen", "_build_workload_fairness_card", 0),

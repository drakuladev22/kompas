...
YALNIZ `src/` və `tests/` ilə işlə (tələb mənbəyi `kompasos.md` — işçi ağacında yoxdur, yuxarıdakı qeydə bax). .venv/, venv/, dist/, build/, __pycache__/, node_modules/, .git/ qovluqlarına HEÇ VAXT girmə.
